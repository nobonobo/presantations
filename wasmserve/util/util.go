...
var (
	...
	flagWorkdir = flag.String("work", ".", "Working directory")
)
...
func handle(w http.ResponseWriter, r *http.Request) {
	...
	fpath := filepath.Join(*flagWorkdir, upath)
